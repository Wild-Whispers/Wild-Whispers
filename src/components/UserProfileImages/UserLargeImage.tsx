...
export default function UserLargeImage({ user, onClick }: { user: User, onClick?: () => void }) {
        ...
        ">
            {
                ...
                <div className="flex justify-center items-center w-full h-full rounded-4xl bg-sky-700">
                    <p className="text-7xl font-semibold select-none">{user.userName.charAt(0).toUpperCase()}</p>
                </div>
            }
        </div>
    );
